...
export function buildSearchDiscoveryRecord(vin: string, leads: SearchLead[]): NormalizedRecord {
  return {
    ...
    title_status: null,
    damage: null,
    raw_excerpt: `Generated ${leads.length} privacy-first search-pack lead(s) for exact-VIN review (SEARCH_LEADS_GENERATED, not SEARCH_COMPLETED). No pages were fetched or scraped; open the pack (or browser addon) and save findings manually.`,
